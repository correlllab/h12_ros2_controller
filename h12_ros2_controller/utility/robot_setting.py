...
def setup_gains_real(command_publisher):
    ...
    command_publisher.kp[BODY_JOINTS.index('left_hip_yaw_joint')] = 300.0
    command_publisher.kd[BODY_JOINTS.index('left_hip_yaw_joint')] = 25.0
    command_publisher.kp[BODY_JOINTS.index('right_hip_yaw_joint')] = 300.0
    command_publisher.kd[BODY_JOINTS.index('right_hip_yaw_joint')] = 25.0
